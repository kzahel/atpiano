...
using the same red/black visual language. Signed coordinated desktop release
[`0.1.3`](https://github.com/kzahel/atpiano/releases/tag/desktop-v0.1.3)
publishes the change for macOS arm64 and Windows x86_64.
