...
| [`045-client-deployment-continuity.md`](045-client-deployment-continuity.md) | Planned | Exact asset routing, update polling and recovery, and bounded recent hashed-asset retention |
