...
| [`051-signed-macos-update-lane.md`](051-signed-macos-update-lane.md) | Active; signed `0.1.0` published, update proof open | Signed and notarized macOS arm64 baseline, credentialed draft-first release lane, desktop updater, and real installed old-to-new acceptance |
| [`052-user-acquired-score-runtime.md`](052-user-acquired-score-runtime.md) | Active; published core and Windows acquisition/CPU smoke passed | Shared education/research acknowledgement, direct upstream score-runtime acquisition, external activation/removal, and signed-update persistence |
| [`053-windows-desktop-release-lane.md`](053-windows-desktop-release-lane.md) | Active; signed `0.1.0` published, update proof open | Windows x64 CPU sidecar/package adaptation, signed per-user NSIS lane, machine-control acceptance, and real installed updater proof |
