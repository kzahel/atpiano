...
| [`011-pitch-verification-views.md`](011-pitch-verification-views.md) | In progress | Independently toggleable piano roll and exact-pitch keyboard views with aligned octave landmarks and source-time inspection |
