...
| [`004-noise-gated-onset-display.md`](004-noise-gated-onset-display.md) | Review | Room-noise gating, a physical 52/36-key layout, and duration-free sequential grand-staff onsets are implemented; subjective retest remains |
