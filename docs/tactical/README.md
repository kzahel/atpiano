...
| [`012-committed-score-snapshots.md`](012-committed-score-snapshots.md) | In progress | Internal MIDI2ScoreTransformer snapshots over committed, closed v2 notes with isolated CPU execution and OSMD rendering |
