...
| [`007-live-timing-rhythm-guides.md`](007-live-timing-rhythm-guides.md) | Planned | Source-onset timing labels and preset-based rough rhythm glyphs expose performance spacing without changing transcription |
