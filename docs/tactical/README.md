...
| [`055-macos-microphone-entitlement-repair.md`](055-macos-microphone-entitlement-repair.md) | Complete; `0.1.2` public | Hardened macOS audio-input signing repair, fail-closed release checks, and physical-microphone replacement gate |
| [`056-website-aligned-application-theme.md`](056-website-aligned-application-theme.md) | Complete; `0.1.3` public | Website-aligned light palette, explicit persistent dark mode, and matching native desktop window chrome |
