...
| [`010-corrected-note-workbench-v2.md`](010-corrected-note-workbench-v2.md) | Active | First complete v2 milestone: separate corrected-note app, aligned replay, bounded sessions, trailing Transkun commit, pedal, review, and export; engraving excluded |
