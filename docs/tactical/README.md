...
| [`006-live-confidence-display-controls.md`](006-live-confidence-display-controls.md) | Active | Add raw/grouped onset controls and optional onset-score labels without changing recognition |
