...
| [`051-signed-macos-update-lane.md`](051-signed-macos-update-lane.md) | Active; coordinated publication prerequisite | Signed and notarized macOS arm64 baseline, credentialed draft-first release lane, desktop updater, and real installed old-to-new acceptance |
| [`052-user-acquired-score-runtime.md`](052-user-acquired-score-runtime.md) | Planned; two-platform publication prerequisite | Shared education/research acknowledgement, direct upstream score-runtime acquisition, external activation/removal, and signed-update persistence |
| [`053-windows-desktop-release-lane.md`](053-windows-desktop-release-lane.md) | Planned; coordinated publication prerequisite | Windows x64 CPU sidecar/package adaptation, signed per-user NSIS lane, machine-control acceptance, and real installed updater proof |
