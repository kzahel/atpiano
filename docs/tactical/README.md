...
| [`052-user-acquired-score-runtime.md`](052-user-acquired-score-runtime.md) | Active; Windows acquisition/CPU smoke passed | Shared education/research acknowledgement, direct upstream score-runtime acquisition, external activation/removal, and signed-update persistence |
| [`053-windows-desktop-release-lane.md`](053-windows-desktop-release-lane.md) | Active; unsigned install/acquisition accepted | Windows x64 CPU sidecar/package adaptation, signed per-user NSIS lane, machine-control acceptance, and real installed updater proof |
