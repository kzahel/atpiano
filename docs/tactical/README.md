...
| [`051-signed-macos-update-lane.md`](051-signed-macos-update-lane.md) | Active; signed `0.1.1` published, update proof open | Signed and notarized macOS arm64 baseline, credentialed draft-first release lane, desktop updater, and real installed old-to-new acceptance |
| [`052-user-acquired-score-runtime.md`](052-user-acquired-score-runtime.md) | Active; both platform acquisition/CPU flows passed | Shared education/research acknowledgement, direct upstream score-runtime acquisition, external activation/removal, and signed-update persistence |
