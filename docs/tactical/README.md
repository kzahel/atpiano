...
| [`039-continuous-library-playback.md`](039-continuous-library-playback.md) | Accepted; implementing | One route-independent playback transport, library seeking, first-note cueing, and clickable synchronized opening previews |
