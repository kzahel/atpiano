...
| [`005-strict-onset-decoder-spike.md`](005-strict-onset-decoder-spike.md) | Active | Compare explicit-onset decoding and reattack evidence, then integrate only a policy that reduces held-chord clutter without deleting fixture repeats |
