...
| [`002-performance-notation-spikes.md`](002-performance-notation-spikes.md) | Proposed | Compare MusicXML renderers, transparent performance-to-score baselines, and hypothesis/override UX |
