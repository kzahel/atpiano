...
| [`056-website-aligned-application-theme.md`](056-website-aligned-application-theme.md) | Complete in source; release pending | Website-aligned light palette, explicit persistent dark mode, and matching native desktop window chrome |
